...
## Usage
    ...
    # Some player account endpoints, e.g. /v2/pvp/stats, require an authenticated connection to the Guild Wars 2 API.
    ...
    # Likewise, you can securely retrieve access token information for the session token or a given API key.
